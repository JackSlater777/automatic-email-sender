...
class TestTasksSuite:
    ...
    @pytest.fixture(
        scope='function',
        params=[
            (None, (['dualking1991@gmail.com', 'JackSlater777@yandex.ru'], ['test1', 'test2']))

            # ('-08-15', (['dualking1991@gmail.com', 'JackSlater777@yandex.ru'], ['test1', 'test2'])),
            # ('-1', (['dualking1991@gmail.com', 'JackSlater777@yandex.ru', 'fletcher-lind@mail.ru'], ['test1', 'test2', 'test3'])),
            # ('2022.08.08', ([], [])),
            # ('', (['dualking1991@gmail.com', 'JackSlater777@yandex.ru', 'fletcher-lind@mail.ru'], ['test1', 'test2', 'test3']))
            ],
